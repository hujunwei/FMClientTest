...
namespace FMtest
{
    public class FaciliityMasterClient
    {
        ...
        /// <exception cref="System.Exception">QueryFacilityMaster returns insuccess response
        /// or
        /// QueryFacilityMaster returns insuccess response
        /// or
        /// Invalid attributeType</exception>
        ...
        /// </returns>
        /// <exception cref="System.ArgumentException"></exception>
        /// <exception cref="System.Exception">Certificate not found
        /// or
        /// Get facility master response fail</exception>
